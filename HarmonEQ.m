...
%
    ...
    properties (Constant, Hidden)
        PluginInterface = audioPluginInterface(...
            ...
            'DisplayName','High-Mid Region Gain',...
            'Mapping',{'lin',-15,15},...
            'Style','vslider',...
            'Layout',[1,4;2,4],...
            'DisplayNameLocation','none'),...
            audioPluginParameter('highMidRegionQFactor',...
            'DisplayName','High-Mid Region Q Factor',...
            'Mapping',{'pow', 2, 0.5, 100},...
            'Style','rotary',...
            'Layout',[3,4],...
            'DisplayNameLocation','none'),...
            ...
            'DisplayName','Mid Region Gain',...
            'Mapping',{'lin',-15,15},...
            'Style','vslider',...
            'Layout',[1,3;2,3],...
            'DisplayNameLocation','none'),...
            audioPluginParameter('midRegionQFactor',...
            'DisplayName','Mid Region Q Factor',...
            'Mapping',{'pow', 2, 0.5, 100},...
            'Style','rotary',...
            'Layout',[3,3],...
            'DisplayNameLocation','none'),...
            ...
            'DisplayName','Low-Mid Region Gain',...
            'Mapping',{'lin',-15,15},...
            'Style','vslider',...
            'Layout',[1,2;2,2],...
            'DisplayNameLocation','none'),...
            audioPluginParameter('lowMidRegionQFactor',...
            'DisplayName','Low-Mid Region Q Factor',...
            'Mapping',{'pow', 2, 0.5, 100},...
            'Style','rotary',...
            'Layout',[3,2],...
            'DisplayNameLocation','none'),...
            ...
            'RowHeight',[100,100,100,100],...
            'ColumnWidth',[100,100,100,100,100,200],...
            'RowSpacing',15)...
            );
    end
