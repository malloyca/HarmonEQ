...
%             'Mapping',{'pow', 2, 0.5, 100}),...
    ...
    methods (Access = private)
        ...
        function updateThirdFilter8Params(plugin)
            if plugin.thirdFrequency8 < plugin.highCrossoverFreq % third filter 8 is in high-mid control region
            ...
            else % then third filter 8 is in high control region
        ...
        function updateFifthFilter4Params(plugin)
            if plugin.fifthFrequency4 < plugin.lowMidCrossoverFreq % fifth filter 4 is in low-mid control region
            ...
            else % then fifth filter 4 is in mid control region
        ...
        function updateSeventhFilter6Params(plugin)
            ...
            else % then seventh filter 6 is in high-mid control region
        ...
        function updateSeventhFilter8Params(plugin)
            if plugin.seventhFrequency8 < plugin.highCrossoverFreq % seventh filter 8 is in high-mid control region
            ...
            else % then seventh filter 8 is in high control region
